...
@Order(elements={"vocabularyElementList",
        "extension",
        "any"})
@Root(strict=false)
public class VocabularyType {

    @Element(name = "VocabularyElementList")
    private VocabularyElementListType vocabularyElementList;

    @Element(name="extension", required=false)
    private VocabularyExtensionType extension;

    @ElementList(name="any")
