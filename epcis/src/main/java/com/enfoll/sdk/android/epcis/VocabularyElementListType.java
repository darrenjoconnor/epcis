...
@Order(elements={"vocabularyElement"})
@Root(strict=false)
public class VocabularyElementListType {

    @ElementList(name = "VocabularyElement", entry="VocabularyElementType", required = false)
    private List<VocabularyElementType> vocabularyElement;
    ...
    public List<VocabularyElementType> getVocabularyElement() {
        if (vocabularyElement == null) {
            vocabularyElement = new ArrayList<>();
        }
