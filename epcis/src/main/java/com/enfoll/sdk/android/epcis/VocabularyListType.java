 ...
 *       &lt;sequence>
 *         &lt;element name="Vocabulary" type="{urn:epcglobal:epcis:xsd:1}VocabularyType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@Order(elements={"vocabulary"})
@Root(strict=false)
public class VocabularyListType {

    @ElementList(name = "Vocabulary", entry="VocabularyType", required=false, inline=true)
    private List<VocabularyType> vocabulary;
