...
public class EPCISDocumentType extends Document
{
    ...
    @Element(name = "EPCISHeader", required = false)
    private EPCISHeaderType epcisHeader;

    @Element(name = "EPCISBody")
    ...
    private DocumentExt ext;

    @ElementList(name="any", entry="Object", required=false, inline=true)
    private List<Object> any;

//    @ElementMap(entry="otherAttributes", key="key", attribute=true, inline=true)
     ...
     *     
     */
    public void setEPCISHeader( @NonNull EPCISHeaderType value) {
     ...
     *     
     */
    public void setEPCISBody( @NonNull EPCISBodyType value) {
     ...
     *     
     */
    public void setExtension( @NonNull EPCISDocumentExtensionType value) {
